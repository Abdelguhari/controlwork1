...
public class Form extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            ResultSet resultSet = stmId.executeQuery("SELECT nextval('users_seq')");
            resultSet.next();
            ...
            PreparedStatement stm2 = conn.prepareStatement("INSERT INTO userinfo (id, name, phone, birthday) VALUES (?, ?, ?, ?);");
